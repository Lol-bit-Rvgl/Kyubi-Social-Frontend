...
class _Post extends Post {
  const _Post({required this.id, required this.type, required this.title, required this.body, required this.author, required this.reactions, required this.stats, required this.isLiked, this.myReaction, this.coverImageUrl, this.bgImageUrl, this.bgOverlay = 0.55, this.bgBlur = false, final  List<String> tags = const <String>[], final  List<String> genres = const <String>[], final  List<String> mediaUrls = const <String>[], @JsonKey(fromJson: mediaListFromJson, toJson: mediaListToJson) final  List<Media> media = const <Media>[], @JsonKey(fromJson: mediaFromJson, toJson: mediaToJson) this.cover, this.audioUrl, this.chapterMode = false, this.chapterNumber, this.warnings, @JsonKey(fromJson: nullableDateFromJson, toJson: nullableDateToJson) this.publishedAt, this.themeBgColor, this.themeAccent, this.fontFamily, required this.timeAgo, final  Map<String, dynamic>? extensions}): _tags = tags,_genres = genres,_mediaUrls = mediaUrls,_media = media,_extensions = extensions,super._();
