...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,type,title,body,author,reactions,stats,isLiked,visibility,myReaction,coverImageUrl,bgImageUrl,bgOverlay,bgBlur,const DeepCollectionEquality().hash(tags),const DeepCollectionEquality().hash(genres),const DeepCollectionEquality().hash(mediaUrls),const DeepCollectionEquality().hash(media),cover,audioUrl,chapterMode,chapterNumber,warnings,isEdited,createdAt,updatedAt,publishedAt,themeBgColor,themeAccent,fontFamily,timeAgo,const DeepCollectionEquality().hash(extensions)]);

@override
String toString() {
  return 'Post(id: $id, type: $type, title: $title, body: $body, author: $author, reactions: $reactions, stats: $stats, isLiked: $isLiked, visibility: $visibility, myReaction: $myReaction, coverImageUrl: $coverImageUrl, bgImageUrl: $bgImageUrl, bgOverlay: $bgOverlay, bgBlur: $bgBlur, tags: $tags, genres: $genres, mediaUrls: $mediaUrls, media: $media, cover: $cover, audioUrl: $audioUrl, chapterMode: $chapterMode, chapterNumber: $chapterNumber, warnings: $warnings, isEdited: $isEdited, createdAt: $createdAt, updatedAt: $updatedAt, publishedAt: $publishedAt, themeBgColor: $themeBgColor, themeAccent: $themeAccent, fontFamily: $fontFamily, timeAgo: $timeAgo, extensions: $extensions)';
}
...
/// Create a copy of Post
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? title = null,Object? body = null,Object? author = null,Object? reactions = null,Object? stats = null,Object? isLiked = null,Object? visibility = null,Object? myReaction = freezed,Object? coverImageUrl = freezed,Object? bgImageUrl = freezed,Object? bgOverlay = null,Object? bgBlur = null,Object? tags = null,Object? genres = null,Object? mediaUrls = null,Object? media = null,Object? cover = freezed,Object? audioUrl = freezed,Object? chapterMode = null,Object? chapterNumber = freezed,Object? warnings = freezed,Object? isEdited = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? publishedAt = freezed,Object? themeBgColor = freezed,Object? themeAccent = freezed,Object? fontFamily = freezed,Object? timeAgo = null,Object? extensions = freezed,}) {
...
as PostWarnings?,isEdited: null == isEdited ? _self.isEdited : isEdited // ignore: cast_nullable_to_non_nullable
...
class _Post extends Post {
  const _Post({required this.id, required this.type, required this.title, required this.body, required this.author, required this.reactions, required this.stats, required this.isLiked, this.visibility = 'PUBLIC', this.myReaction, this.coverImageUrl, this.bgImageUrl, this.bgOverlay = 0.55, this.bgBlur = false, final  List<String> tags = const <String>[], final  List<String> genres = const <String>[], final  List<String> mediaUrls = const <String>[], @JsonKey(fromJson: mediaListFromJson, toJson: mediaListToJson) final  List<Media> media = const <Media>[], @JsonKey(fromJson: mediaFromJson, toJson: mediaToJson) this.cover, this.audioUrl, this.chapterMode = false, this.chapterNumber, this.warnings, this.isEdited = false, @JsonKey(fromJson: nullableDateFromJson, toJson: nullableDateToJson) this.createdAt, @JsonKey(fromJson: nullableDateFromJson, toJson: nullableDateToJson) this.updatedAt, @JsonKey(fromJson: nullableDateFromJson, toJson: nullableDateToJson) this.publishedAt, this.themeBgColor, this.themeAccent, this.fontFamily, required this.timeAgo, final  Map<String, dynamic>? extensions}): _tags = tags,_genres = genres,_mediaUrls = mediaUrls,_media = media,_extensions = extensions,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,type,title,body,author,reactions,stats,isLiked,visibility,myReaction,coverImageUrl,bgImageUrl,bgOverlay,bgBlur,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_genres),const DeepCollectionEquality().hash(_mediaUrls),const DeepCollectionEquality().hash(_media),cover,audioUrl,chapterMode,chapterNumber,warnings,isEdited,createdAt,updatedAt,publishedAt,themeBgColor,themeAccent,fontFamily,timeAgo,const DeepCollectionEquality().hash(_extensions)]);
